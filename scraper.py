...
# ⚠️ Tus cookies reales (NO CAMBIAR si ya funcionan)
cookies = {
...
headers = {
    ...
    "x-fb-lsd": "_lDTv_4xPjdmXMx51XBkBI",  # si falla, vuelve a copiar del navegador
...
for page in range(3):  # número de páginas
    print(f"\n📄 Página {page + 1}")
    ...
    if "application/json" not in response.headers.get("Content-Type", ""):
        print("❌ Bloqueado o respuesta no JSON")
